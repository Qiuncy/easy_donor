...
class ConfirmDonationWidget extends StatefulWidget {
  const ConfirmDonationWidget({Key? key}) : super(key: key);
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0, 10, 0, 0),
                                      child: TextFormField(
                                        controller: donationsController.item,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'WHAT ARE YOU DONATING ?',
                                          hintText: 'ENTER WHAT YOU DONATING ',
                                          hintStyle: FlutterFlowTheme.of(context)
                                              .bodyText2,
                                          enabledBorder: OutlineInputBorder(
                                            borderSide: BorderSide(
                                              color: Color(0xFFC9CCDB),
                                              width: 1,
                                            ),
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0, 10, 0, 0),
                                      child: TextFormField(
                                        controller: donationsController.date,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0, 10, 0, 0),
                                      child: TextFormField(
                                        controller: donationsController.description,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: (() {
                                          ...
                                          Get.snackbar("Success", "Thank you for donating today");
                                        }),
                                        child: Container(
